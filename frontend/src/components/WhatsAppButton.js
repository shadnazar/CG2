...
function WhatsAppButton({ 
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed bottom-24 right-4 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center group ${className}`}
