      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          ...
          <form onSubmit={handleTrack} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold rounded-xl hover:from-green-600 hover:to-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        {orders && orders.length === 0 && (
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <Link
              to="/product"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold rounded-xl hover:from-green-600 hover:to-emerald-600"
            >
              Shop Now
            </Link>
          </div>
