    ...
    <div className="space-y-6" data-testid="admin-retention">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => setDays(15)} className={`px-4 py-2 rounded-xl text-sm font-medium ${days === 15 ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600'}`}>15 Days</button>
          <button onClick={() => setDays(30)} className={`px-4 py-2 rounded-xl text-sm font-medium ${days === 30 ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600'}`}>30 Days</button>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md p-6">
            ...
            <div className="flex gap-2">
              <button onClick={saveNote} className="flex-1 bg-emerald-600 text-white font-bold py-2 rounded-xl">Save</button>
